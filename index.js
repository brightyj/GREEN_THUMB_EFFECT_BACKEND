...
app.use(cors({
    origin: ['https://green-thumb-effect-frontend-7mxw.onrender.com', 'https://green-thumb-effect-admin.onrender.com', 'https://localhost:4000'],
...
app.post("/upload", upload.single('product'), (req, res) => {
    ...
    res.json({
        success: 1,
        image_url: `https://green-thumb-effect-backend.onrender.com/upload/images/product_1712162009568.png`
    });
});
